## python3 trigger-gitlab-pipeline.py --project_id=9 --token=glpt-mytoken --ref=main --target_server=servername --ssh_host=server.example.com --ssh_password=PASSWORD
import requests
import json
import fire
